...
- `RELEASE.md` documenting the release process (version bump, changelog roll, annotated tag, `develop`→`main` promotion) and the three-tier branch model, so the publish boundary cannot silently drift again. (#67)
